...
function(_add_variant_c_compile_flags)
  ...
  if("${CFLAGS_SDK}" STREQUAL "WEBASSEMBLY")
    list(APPEND result "-D__wasm__")
    list(APPEND result "-D__wasm32__")
    list(APPEND result "-I${SWIFT_PATH_TO_LIBC_SOURCE}/include")
    list(APPEND result "-I${SWIFT_PATH_TO_LIBC_SOURCE}/arch/wasm32")
    list(APPEND result "-I${SWIFT_PATH_TO_LIBC_BUILD}/include")
    if("${CMAKE_SYSTEM_NAME}" STREQUAL "Linux")
      list(APPEND result "-I${SWIFT_PATH_TO_LIBCXX_BUILD}/include/c++/7")
    else()
      list(APPEND result "-I${SWIFT_PATH_TO_LIBCXX_BUILD}/include/c++/v1")
    endif()
    list(APPEND result "-I${SWIFT_PATH_TO_LIBICU_SOURCE}/source/common")
    list(APPEND result "-I${SWIFT_PATH_TO_LIBICU_SOURCE}/source/i18n")
  endif()
